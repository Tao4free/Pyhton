...
class EasyMinimumLabelingDialog(QDialog, Ui_Dialog):
    ...
    def __init__(self, iface):
        ...
        super(self.__class__, self).__init__(None, Qt.WindowStaysOnTopHint)
        ...
        #print layer, layer.name(), layer.type() == QgsMapLayer.VectorLayer
        ...
        if (layer) and layer.type() == QgsMapLayer.VectorLayer:
            ...
            #infoString = unicode("<font color='black'> 1. </font>" + "<font color='red'> <b>No layer selected... Select a layer from the layer list...</b></font>")
            #self.ui.lbField.setText(infoString)
            self.falseSet()
    ...
    def createField(self):
        ...
        #print nF
        #self.ui.txX.setText("Yes, you can!")
        
        # Get the text of comobox
        lbField_origin = str(self.ui.cbField.currentText())
        #print lbField_origin
    ...
    def write(self):
        ...
        if not flag_create:
            self.createField()
            #print flag_create
        #self.ui.txY.setText("I also think so!")
